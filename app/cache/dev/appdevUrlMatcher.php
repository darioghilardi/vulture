...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // VultureMainBundle_homepage
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'VultureMainBundle_homepage');
            }
            return array (  '_controller' => 'Vulture\\MainBundle\\Controller\\DefaultController::indexAction',  '_route' => 'VultureMainBundle_homepage',);
        }

        // VultureMainBundle_results
        if ($pathinfo === '/results') {
            return array (  '_controller' => 'Vulture\\MainBundle\\Controller\\DefaultController::resultsAction',  '_route' => 'VultureMainBundle_results',);
        }
